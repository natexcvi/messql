...
export class ConnectionPage extends BasePage {
  ...
  constructor(page: Page) {
    super(page)
    this.newConnectionButton = page.locator('[data-testid="new-connection-btn"]')
    this.connectionNameInput = page.locator('[data-testid="connection-name-input"]')
    ...
    this.saveConnectionButton = page.locator('[data-testid="save-connection-btn"]')
    ...
    this.deleteConnectionButton = page.locator('[data-testid="delete-connection-btn"]')
    this.editConnectionButton = page.locator('[data-testid="edit-connection-btn"]')
